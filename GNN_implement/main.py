...
def parse_args(data_name="mutag", epoch=100, learning_rate=0.00001, directed=False):
    ...
    parser.add_argument("--directed", type=bool, default=directed, help="directed or undirected")
...
def gnn(args):
    ...
    D_inverse, A_tilde, Y, X, nodes_size_list, initial_feature_dimension = create_input(data, args.directed)
